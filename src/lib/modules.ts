export const MODULES = [
  ...
  },
  {
    ...
    description: 'Ajoutez des visites Matterport, Kuula, 3D Vista, CloudPano ou videos 360 sur les fiches biens.',
    price: 29,
    icon: 'Video',
    color: 'teal',
    benefits: [
      'Bouton visite immersive sur chaque fiche bien',
      'Compatible liens Matterport, Kuula, 3D Vista et CloudPano',
      'Compatible videos 360, YouTube et Vimeo',
      'Preparation vers la future realite augmentee',
    ],
  },
  {
    id: 'crm_sync',
...
export const PLANS = [
  ...
  },
  {
    ...
    name: 'Platinum',
    price: 179,
    modules: ['site_web', 'mini_crm', 'whatsapp', 'property_manager', 'seo', 'immersive-tours', 'crm_sync', 'chatbot'],
    color: 'purple',
    savings: 55,
