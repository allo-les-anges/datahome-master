...
const TEMPLATES: Record<Lang, (otp: string, prenom: string) => Template> = {
  fr: (otp, p) => ({ subject: 'Votre code de validation Premium — Data-Home', html: baseHtml({ otp, greeting: `Bonjour ${p},`, intro: `Merci pour votre inscription à l'offre <strong>Premium</strong> de Data-Home. Pour finaliser votre accès, veuillez utiliser le code de validation ci-dessous. Ce code est strictement personnel et confidentiel.`, label: 'Votre code de validation', note: '⏱ Ce code expire dans 15 minutes.', cta: `Si vous n'êtes pas à l'origine de cette demande, vous pouvez ignorer cet e-mail en toute sécurité.`, footer: '© Data-Home · noreply@data-home.app · Ne pas répondre à cet e-mail.' }) }),
  en: (otp, p) => ({ subject: 'Your Premium Validation Code — Data-Home', html: baseHtml({ otp, greeting: `Dear ${p},`, intro: `Thank you for registering for the <strong>Premium</strong> plan at Data-Home. To complete your access, please use the validation code below. This code is strictly personal and confidential.`, label: 'Your validation code', note: '⏱ This code expires in 15 minutes.', cta: `If you did not initiate this request, you can safely ignore this e-mail.`, footer: '© Data-Home · noreply@data-home.app · Please do not reply to this e-mail.' }) }),
  nl: (otp, p) => ({ subject: 'Uw Premium-validatiecode — Data-Home', html: baseHtml({ otp, greeting: `Beste ${p},`, intro: `Bedankt voor uw inschrijving voor het <strong>Premium</strong>-abonnement bij Data-Home. Om uw toegang te voltooien, gebruikt u de onderstaande validatiecode. Deze code is strikt persoonlijk en vertrouwelijk.`, label: 'Uw validatiecode', note: '⏱ Deze code verloopt over 15 minuten.', cta: `Als u dit verzoek niet heeft ingediend, kunt u deze e-mail veilig negeren.`, footer: '© Data-Home · noreply@data-home.app · Beantwoord deze e-mail niet.' }) }),
  es: (otp, p) => ({ subject: 'Su código de validación Premium — Data-Home', html: baseHtml({ otp, greeting: `Estimado/a ${p},`, intro: `Gracias por registrarse en el plan <strong>Premium</strong> de Data-Home. Para completar su acceso, utilice el código de validación que aparece a continuación. Este código es estrictamente personal y confidencial.`, label: 'Su código de validación', note: '⏱ Este código expira en 15 minutos.', cta: `Si no realizó esta solicitud, puede ignorar este correo electrónico con total seguridad.`, footer: '© Data-Home · noreply@data-home.app · No responda a este correo.' }) }),
  pl: (otp, p) => ({ subject: 'Twój kod weryfikacyjny Premium — Data-Home', html: baseHtml({ otp, greeting: `Szanowny/a ${p},`, intro: `Dziękujemy za rejestrację w planie <strong>Premium</strong> Data-Home. Aby dokończyć aktywację konta, prosimy o użycie poniższego kodu weryfikacyjnego. Kod ten jest ściśle osobisty i poufny.`, label: 'Twój kod weryfikacyjny', note: '⏱ Kod wygaśnie za 15 minut.', cta: `Jeśli nie składałeś/aś tej prośby, możesz bezpiecznie zignorować tę wiadomość.`, footer: '© Data-Home · noreply@data-home.app · Prosimy nie odpowiadać na tę wiadomość.' }) }),
  ru: (otp, p) => ({ subject: 'Ваш код подтверждения Premium — Data-Home', html: baseHtml({ otp, greeting: `Уважаемый/ая ${p},`, intro: `Благодарим вас за регистрацию в тарифе <strong>Premium</strong> на платформе Data-Home. Для завершения активации учётной записи воспользуйтесь приведённым ниже кодом подтверждения. Этот код является строго личным и конфиденциальным.`, label: 'Ваш код подтверждения', note: '⏱ Код действителен в течение 15 минут.', cta: `Если вы не инициировали этот запрос, просто проигнорируйте данное письмо.`, footer: '© Data-Home · noreply@data-home.app · Пожалуйста, не отвечайте на это письмо.' }) }),
  no: (otp, p) => ({ subject: 'Din Premium-bekreftelseskode — Data-Home', html: baseHtml({ otp, greeting: `Kjære ${p},`, intro: `Takk for at du registrerte deg for <strong>Premium</strong>-planen hos Data-Home. For å fullføre tilgangen din, bruk bekreftelseskoden nedenfor. Denne koden er strengt personlig og konfidensiell.`, label: 'Din bekreftelseskode', note: '⏱ Denne koden utløper om 15 minutter.', cta: `Hvis du ikke ba om dette, kan du trygt ignorere denne e-posten.`, footer: '© Data-Home · noreply@data-home.app · Ikke svar på denne e-posten.' }) }),
  da: (otp, p) => ({ subject: 'Din Premium-bekræftelseskode — Data-Home', html: baseHtml({ otp, greeting: `Kære ${p},`, intro: `Tak fordi du tilmeldte dig <strong>Premium</strong>-planen hos Data-Home. For at fuldføre din adgang skal du bruge bekræftelseskoden nedenfor. Denne kode er strengt personlig og fortrolig.`, label: 'Din bekræftelseskode', note: '⏱ Denne kode udløber om 15 minutter.', cta: `Hvis du ikke anmodede om dette, kan du roligt ignorere denne e-mail.`, footer: '© Data-Home · noreply@data-home.app · Besvar venligst ikke denne e-mail.' }) }),
  de: (otp, p) => ({ subject: 'Ihr Premium-Bestätigungscode — Data-Home', html: baseHtml({ otp, greeting: `Sehr geehrte/r ${p},`, intro: `Vielen Dank für Ihre Registrierung beim <strong>Premium</strong>-Plan von Data-Home. Um Ihren Zugang abzuschließen, verwenden Sie bitte den untenstehenden Bestätigungscode. Dieser Code ist streng persönlich und vertraulich.`, label: 'Ihr Bestätigungscode', note: '⏱ Dieser Code läuft in 15 Minuten ab.', cta: `Falls Sie diese Anfrage nicht gestellt haben, können Sie diese E-Mail bedenkenlos ignorieren.`, footer: '© Data-Home · noreply@data-home.app · Bitte antworten Sie nicht auf diese E-Mail.' }) }),
};
...
// ─── Resend email ──────────────────────────────────────────────────────────────
async function sendEmail(to: string, lang: Lang, otp: string, prenom: string): Promise<void> {
