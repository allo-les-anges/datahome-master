...
const i18n = {
  fr: {
    ...
    trial_title: "Dossier soumis !", trial_sub: "Votre site est en cours de validation. Notre équipe l'active sous 24h — vous recevrez un email dès qu'il sera en ligne.",
  ...
  en: {
    ...
    trial_title: "Application submitted!", trial_sub: "Your site is under review. Our team activates it within 24h — you'll receive an email once it's live.",
  ...
  es: {
    ...
    trial_title: "¡Solicitud enviada!", trial_sub: "Su sitio está en proceso de validación. Nuestro equipo lo activa en 24h — recibirá un email cuando esté en línea.",
  ...
  nl: {
    ...
    trial_title: "Aanvraag ingediend!", trial_sub: "Uw site wordt gevalideerd. Ons team activeert het binnen 24u — u ontvangt een e-mail zodra het online is.",
  ...
  de: {
    ...
    trial_title: "Antrag eingereicht!", trial_sub: "Ihre Website wird validiert. Unser Team aktiviert sie innerhalb von 24h — Sie erhalten eine E-Mail, sobald sie online ist.",
  ...
  pl: {
    ...
    trial_title: "Wniosek złożony!", trial_sub: "Twoja strona jest weryfikowana. Nasz zespół aktywuje ją w ciągu 24h — otrzymasz e-mail, gdy będzie online.",
